...
class BybitCache extends BaseGlobalCache {
     ...
     *
     * **DEV:** Bybit requires order symbol for many requests. So we should cache orders to delete it just by id.
     *
